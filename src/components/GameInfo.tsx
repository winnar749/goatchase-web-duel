...
const GameInfo: React.FC = () => {
  return (
    <div className="w-full bg-background rounded-lg shadow-md">
      <Card className="p-4">
        ...
        <Accordion type="single" collapsible className="w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <AccordionItem value="rules" className="border rounded-lg p-2">
              <AccordionTrigger className="py-2">Game Rules</AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="strategy" className="border rounded-lg p-2">
              <AccordionTrigger className="py-2">Strategy Tips</AccordionTrigger>
              <AccordionContent>
                <div className="space-y-3 text-sm text-left">
            ...
            <AccordionItem value="ai" className="border rounded-lg p-2">
              <AccordionTrigger className="py-2">AI Information</AccordionTrigger>
              <AccordionContent>
                <div className="space-y-3 text-sm text-left">
                  <p>
